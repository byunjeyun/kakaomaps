...
<h3 style="background-color:green; color:white; text-align:center; padding:10px 0 10px 0;">DB주소 검색</br></h3>
...
<p class="getdata">
<button class="button02" onclick="selectOverlay('CIRCLE')">원</button>
<button class="button02" onclick="selectOverlay('RECTANGLE')">사각형</button>
<button class="button02" onclick="selectOverlay('POLYGON')">다각형</button>
<button style="background-color: green; color:#fff;" class="button01" onclick="getDataFromDrawingMap()">선택완료</button>
</p>
